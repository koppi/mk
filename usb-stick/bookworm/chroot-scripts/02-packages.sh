...
apt -qqq -y install linuxcnc linuxcnc-dev linuxcnc-doc-en
apt -qqq -y install ethercat-master linuxcnc-ethercat
#apt -qqq -y install jstest-gtk joystick
apt -qqq -y install lightdm xfce4 xfdesktop4 xfce4-goodies xfce4-power-manager xfce4-session xfce4-terminal xfwm4-themes
